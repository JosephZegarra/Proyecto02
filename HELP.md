...
* The original package name 'com.alexander.curso.spring.boot.webapp.springboot-web' is invalid and this project uses 'com.alexander.curso.spring.boot.webapp.springboot_web' instead.
